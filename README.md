...
```bash
sudo bash -c 'apt-get update && apt-get install -y git && git clone https://github.com/paulusgi/asir-vps-defense.git /opt/asir-vps-defense && cd /opt/asir-vps-defense && chmod +x deploy.sh && ./deploy.sh'
```
