...
- **Atrae atacantes** — SSH abierto a contraseña (el cebo)
- **Protege al admin** — Autenticación exclusiva por clave pública
- **Registra todo** — Loki + panel web accesible solo por túnel SSH
- **Banea con dureza** — Fail2Ban con política de 35 días
- **Geolocaliza** — Base de datos local, sin depender de APIs externas
...
Todo corre en Docker dentro del VPS. El único puerto expuesto a Internet es SSH.

El panel web escucha en `127.0.0.1:8888` — solo accesible si abres un túnel SSH desde tu máquina.
