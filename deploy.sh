...
# Número de fallos permitidos antes del ban (6 = 2 intentos reales, cada intento genera 3 líneas de log)
maxretry = 6
...
main() {
    ...
    log_success "Directorio /var/log/cowrie listo (UID 999, lectura por Promtail)"
